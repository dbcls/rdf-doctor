...
from tests.consts import NT_1, TTL_3, REFINE_PREFIX_URIS_FILE_PATH
...
class TestGetPrefixComparisonResult(unittest.TestCase):
    ...
    def test_nt(self):
        ...
        prefix_comparison_result = get_prefix_comparison_result(input_prefixes, str(Path(__file__).resolve().parent.joinpath(REFINE_PREFIX_URIS_FILE_PATH)))
