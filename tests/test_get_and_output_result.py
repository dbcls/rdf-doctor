...
import queue
import shutil
from doctor.doctor import get_and_output_result, get_widely_used_prefixes_dict
from doctor.consts import TARGET_CLASS_ALL
from tests.consts import NT_1, NT_1_GZ, NT_1_ZIP, NT_2, NT_2_GZ, NT_2_ZIP, NT_3, NT_3_GZ, TTL_1, TTL_1_GZ, TTL_1_ZIP, TTL_2, TTL_2_GZ, TTL_2_ZIP, TTL_3, TTL_3_GZ, TTL_3_ZIP, TTL_ERROR, OWL_1, OWL_1_GZ, OWL_1_ZIP, RDF_1, RDF_2, RDF_1_GZ, RDF_1_ZIP, XML_1, XML_1_GZ, XML_1_ZIP, REFINE_PREFIX_URIS_FILE_PATH, REFINE_CLASS_URIS_FILE_PATH, PREFIXES_FILE_PATH, REFINE_PREFIX_URIS_ERROR_FILE_PATH, OUTPUT_DIR
...
class TestEnqueueResult(unittest.TestCase):
    ...
    def test_index_error(self):
        ...
        self.assertEqual(str(error_queue.get()), str(IndexError("[ERROR] An index error occurred while processing [" + TTL_3 + "] Error message: list index out of range")))
