...
class TestGetInputPrefixesTurtle(unittest.TestCase):
    ...
    # TODO: Add zip case
    def test_nt(self):
        input_prefixes, duplicated_prefixes_list, duplicated_prefixes_dict = get_input_prefixes_turtle([NT_1], None)
    ...
    def test_nt_gz(self):
        input_prefixes, duplicated_prefixes_list, duplicated_prefixes_dict = get_input_prefixes_turtle([NT_1_GZ], GZ)
        self.assertEqual(input_prefixes, [])
        self.assertEqual(duplicated_prefixes_list, [])
        self.assertEqual(duplicated_prefixes_dict, {})
    ...
    def test_nt_multi(self):
        input_prefixes, duplicated_prefixes_list, duplicated_prefixes_dict = get_input_prefixes_turtle([NT_1, NT_2, NT_3], None)
        self.assertEqual(input_prefixes, [])
        self.assertEqual(duplicated_prefixes_list, [])
        self.assertEqual(duplicated_prefixes_dict, {})
    ...
    def test_nt_gz_multi(self):
        input_prefixes, duplicated_prefixes_list, duplicated_prefixes_dict = get_input_prefixes_turtle([NT_1_GZ, NT_2_GZ, NT_3_GZ], GZ)
        self.assertEqual(input_prefixes, [])
        self.assertEqual(duplicated_prefixes_list, [])
        self.assertEqual(duplicated_prefixes_dict, {})
