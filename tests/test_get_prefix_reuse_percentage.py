...
from tests.consts import NT_1, NT_1_GZ, TTL_1, TTL_2, TTL_3, TTL_1_GZ, PREFIX_LIST_FILE_PATH
...
class TestGetPrefixReusePercentage(unittest.TestCase):
    ...
    def test_nt(self):
        ...
        result = get_prefix_reuse_percentage(input_prefixes, str(Path(__file__).resolve().parent.joinpath(PREFIX_LIST_FILE_PATH)))
