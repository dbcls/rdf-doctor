...
class TestGetClassComparisonResult(unittest.TestCase):
    ...
    def test_nt(self):
        ...
        class_comparison_result, fingerprint_class_dict = get_class_comparison_result(input_classes, str(Path(__file__).resolve().parent.joinpath(REFINE_CLASS_URIS_FILE_PATH)))
