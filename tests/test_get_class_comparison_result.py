...
from tests.consts import NT_2, TTL_2, CLASS_URI_ERRATA_FILE_PATH
...
class TestGetClassComparisonResult(unittest.TestCase):
    ...
    def test_nt(self):
        ...
        class_comparison_result, fingerprint_class_dict = get_class_comparison_result(input_classes, str(Path(__file__).resolve().parent.joinpath(CLASS_URI_ERRATA_FILE_PATH)))
